    ...
    return (
        <div className="bg-background-dark font-display text-slate-100 min-h-screen selection:bg-primary/30 antialiased">
            ...
            <main className="relative overflow-hidden">
                ...
                {/* Hero Section con contenido expandido */}
                ...
                {/* Platforms Section con contenido expandido */}
                <section className="max-w-7xl mx-auto px-6 py-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {/* Shopify - Con descripción expandida */}
                            ...
                            <div className="flex flex-col gap-6 h-full justify-between">
                                <div className="flex items-center gap-6">
                                    <div className="size-16 rounded-2xl bg-white/5 flex items-center justify-center">
                                        ...
                                        <img src="/shopify-glyph.svg" alt="Shopify" className="size-8" />
                                    </div>
                                    <div>
                                        <h3 className="text-2xl font-bold notranslate" translate="no">Shopify</h3>
                ...
                {/* Nueva sección: Timestamp de actualización y attribution */}
