      ...
      >
        ...
        <div className="grid grid-cols-3 gap-3">
          <form action={signInWithGoogle}>
            <button type="submit" aria-label="Sign in with Google" className="social-btn w-full flex items-center justify-center py-3.5 rounded-xl">
          ...
          <form action={signInWithSlack}>
            <button type="submit" aria-label="Sign in with Slack" className="social-btn w-full flex items-center justify-center py-3.5 rounded-xl">
          ...
          <form action={signInWithX}>
            <button type="submit" aria-label="Sign in with X" className="social-btn w-full flex items-center justify-center py-3.5 rounded-xl text-zinc-950 dark:text-white">
