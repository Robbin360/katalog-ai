        ...
        >
            ...
            <form action={handleSubmit} className="space-y-5">
                ...
                <div>
                    <label
                        htmlFor="email"
                        className="block text-[13px] font-bold tracking-widest uppercase mb-2 ml-1 text-[#d4d4d8]"
                    >
                        Work Email
                    </label>
                    <input
                ...
                <div>
                    <div className="flex justify-between items-center mb-2 ml-1">
                        <label
                            htmlFor="password"
                            className="block text-[13px] font-bold tracking-widest uppercase text-[#d4d4d8]"
                        >
                            Password
                        </label>
                        <Link
                            href="/forgot-password"
                            className="text-[13px] font-bold tracking-widest uppercase text-[#10b77f] hover:opacity-80 transition-opacity"
                        >
                            Forgot Password?
                        </Link>
                    </div>
