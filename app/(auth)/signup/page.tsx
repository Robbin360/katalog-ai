        ...
        >
            ...
            <form action={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label
                        htmlFor="fullname"
                        className="block text-[13px] font-bold tracking-widest uppercase mb-1.5 ml-1 text-[#d4d4d8]"
                    >
                        Full Name
                    </label>
                    <input
                ...
                <div>
                        ...
                        <input
                            ...
                            className={`w-full bg-black/40 dark:bg-black/40 border rounded-xl px-5 py-4 pr-12 text-[17px] text-white placeholder:text-white/20 focus:ring-2 outline-none transition-all duration-300 font-medium ${
                                confirmError
                                    ...
                                    : "border-white/10 focus:ring-[#10b77f]/40 focus:border-[#10b77f]/50"
                            }`}
                        />
                        <button
                            type="button"
                    ...
                    {confirmError && (
                        <p className="text-[12px] text-red-400 font-bold mt-1 ml-1 tracking-wide">
            ...
            <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-[12px] uppercase tracking-[0.2em] font-bold">
                    <span className="px-4 bg-white dark:bg-[#121214]/50 backdrop-blur-sm text-slate-400 dark:text-[#d4d4d8]/40 transition-colors duration-700">
                        Or continue with
                    </span>
                </div>
            </div>
